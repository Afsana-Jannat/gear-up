...
-- CreateEnum
CREATE TYPE "GearAvailability" AS ENUM ('AVAILABLE', 'OUT_OF_STOCK');
...
-- AddForeignKey
ALTER TABLE "gear" ADD CONSTRAINT "gear_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "categories"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "gear" ADD CONSTRAINT "gear_providerId_fkey" FOREIGN KEY ("providerId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "rental_orders" ADD CONSTRAINT "rental_orders_gearId_fkey" FOREIGN KEY ("gearId") REFERENCES "gear"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "reviews" ADD CONSTRAINT "reviews_gearId_fkey" FOREIGN KEY ("gearId") REFERENCES "gear"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
